...
local timerUnchainedMagic		= mod:NewBuffActiveTimer(35, 69762)
...
function mod:OnCombatStart(delay)
	...
	timerNextBlisteringCold:Start(38-delay)
	warned_P2 = false
	warnedfailed = false
	table.wipe(beaconTargets)
	table.wipe(beaconIconTargets)
...
function mod:CHAT_MSG_MONSTER_YELL(msg)
	if (msg == L.YellAirphase or msg:find(L.YellAirphase)) or (msg == L.YellAirphaseDem or msg:find(L.YellAirphaseDem)) then
		...
		timerUnchainedMagic:Start(57)
		timerNextBlisteringCold:Start(60)--Not exact anywhere from 80-110seconds after airphase begin

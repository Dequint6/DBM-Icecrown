...
L:SetTimerLocalization{
	...
	TimerCombatStart		= "Combat starts" --New
}

L:SetOptionLocalization{
	TimerCombatStart		= "Show timer for start of combat", --New
...
L:SetMiscLocalization{
	...
	PullAll				= "Foolish mortals. You thought us defeated so easily? The San'layn are the Lich King's immortal soldiers! Now you shall face their might combined!" -- New
...
L:SetMiscLocalization{
	...
	YellDefile				= "Defile on %s!",
	YellTrap				= "Shadow Trap on %s!",
	YellValk				= "%s been grabbed!",

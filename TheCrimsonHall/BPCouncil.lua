...
local timerCombatStart			= mod:NewTimer(29, "TimerCombatStart", 2457) --new
...
function mod:CHAT_MSG_MONSTER_YELL(msg) --new
	if msg == L.PullAll or msg:find(L.PullAll) then --new

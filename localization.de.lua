...
L:SetMiscLocalization{
	...
	PullAll				= "Dumme Sterbliche Sie dachten, wir hätten uns so leicht besiegt? Die San'layn sind die unsterblichen Soldaten des Lichkönigs! Jetzt sollst du ihrer Macht gegenüberstehen!"
...
L:SetWarningLocalization{
	...
	SpecWarnValkyrLow		= "Valkyr unter 55%"
}
...
L:SetMiscLocalization{
	...
	YellDefile				= "Entweihen auf %s!",
	YellTrap				= "Schattenfalle auf %s!",
	...
	YellValk				= "Val'kyr hat %s gegriffen"
}
